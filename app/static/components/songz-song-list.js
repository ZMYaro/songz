...
import {formatAlbum, formatArtist, formatDuration, formatGenre, showMenuForSong, handleMenuItemSelect } from '../scripts/utils.js';
				...
				<tbody>
					${(this.songs || []).map((song, i) => html`
						<tr data-index="${i}">
							...
							${SHOW_ART ? html`<td><img class="album-art" src="${song.gDriveArt ? getFileURL(song.gDriveArt) : '/images/unknown_album.svg'}" alt="" /></td>` : ''}
